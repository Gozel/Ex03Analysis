...
extension = 'capacitive';
capacitive_data = cell(20,4);
    ...
    for i = 3 : length(subsubFolders)
        ...
        for j = 1 : length(subsubsubFolders)
            ...
            if contains(subsubsubFolders(j).name, extension)
                ...
                capacitive_data{k-2, i-2} = readtable(fileName, 'Delimiter', ':', 'Format', formatSpec, 'HeaderLines', 2);
            end
        end
    end
end

save('capacitive_data.mat', 'capacitive_data');